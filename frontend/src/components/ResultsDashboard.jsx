...
export default function ResultsDashboard({ result, language, farmerId, token, onBack }) {
    ...
    return (
        <div className="px-4 pt-5 pb-4 max-w-lg mx-auto fade-in">
            ...
            {/* Healthy Banner */}
            {result.isHealthy && (
                <div className="bg-green-950/50 border border-green-700/50 
            ...
            {result.urgencyLevel === "IMMEDIATE" && !result.isHealthy && (
                <div className="bg-red-950/60 border border-red-700/50 
            ...
            <div className="disease-card fade-in fade-in-delay-2 flex items-center gap-6">
                ...
                <div>
                    ...
                    <span className={`inline-block mt-2 ${getSeverityClass(result.severity)}`}>
                        {result.severity}
                    </span>
                </div>
            </div>
            ...
            {!result.isHealthy && (
                <div className="bg-red-950/30 border border-red-900/40 rounded-2xl 
                    ...
                    <div className="space-y-3">
                        {result.symptoms.map((symptom, index) => (
                            <div key={index} className="flex items-start gap-3">
                                <div className="flex-shrink-0 w-7 h-7 bg-accent/20 
