...
export default function ResetPasswordPage({ onNavigate }) {
  ...
  const validate = () => {
    ...
    if (!newPassword || newPassword.length < 8)
      ...
      errors.newPassword = 'Must contain 1 uppercase letter'
    else if (!/[0-9]/.test(newPassword))
      errors.newPassword = 'Must contain 1 number'
  ...
  const inputClass = (
    field
  ) => `w-full bg-[var(--bg-elevated)] border rounded-xl px-4 py-3.5
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-2">
            Check your console logs for the 6-digit code
          </p>
        </div>
